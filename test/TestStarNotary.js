...
it('can add the star name and star symbol properly', async() => {
    ...
    await instance.createStar('awesome star', starId, {from: user1})
    //2. Call the name and symbol properties in your Smart Contract and compare with the name and symbol provided4
    assert.equal(await instance.name(), "Africoin");
    assert.equal(await instance.symbol(), "afro");
});
...
it('lets a user transfer a star', async() => {
    ...
    await instance.transferStar(user2, starId, {from: user});
